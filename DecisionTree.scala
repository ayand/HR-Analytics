...
val dt = new DecisionTreeClassifier().setImpurity("gini").setMaxBins(40)

val pipeline = new Pipeline().setStages(Array(salesIndexer, salesEncoder, salaryIndexer, salaryEncoder, assembler, dt))
